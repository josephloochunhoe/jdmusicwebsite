    ...
    <BrowserRouter>
      ...
      <div className="min-h-screen bg-white text-jd-black font-sans selection:bg-jd-burgundy selection:text-white flex flex-col">
        ...
        <a 
          ...
          className={`fixed bottom-24 right-6 z-50 px-8 py-4 rounded-full bg-jd-black text-white font-bold shadow-2xl border-2 border-white/20 hover:bg-gray-800 transition-all duration-300 flex items-center gap-2 ${
